...
public class Calculator extends JFrame {
    ...
    private void toggleDarkMode() {
        ...
        getContentPane().setBackground(isDarkMode ? Color.DARK_GRAY : Color.BLUE);
        display.setBackground(isDarkMode ? Color.WHITE : Color.GREEN);
        display.setForeground(isDarkMode ? Color.BLACK : Color.YELLOW);
        buttonPanel.setBackground(isDarkMode ? Color.DARK_GRAY : Color.ORANGE);
        for (Component component : buttonPanel.getComponents()) {
            if (compenent instanceof JButton) {
